...
public class RecordCountsTest {
    ...
    private static MonitorSource recordCounts;

    @BeforeClass
    public static void initSource() {
        recordCounts = SourceCatalogue.getMonitorSource(MonitorSourceType.RECORD_COUNTS);
    }

    @Test
    public void validate() {
        assertEquals("org.radarcns.application.ApplicationServiceProvider",
                recordCounts.getAppProvider());
        ...
        testTopicNonAggregatable("application_record_counts",
            ...
            "org.radarcns.monitor.application.ApplicationRecordCounts",
            actor.getTopic());
    }
}
