...
public class PassiveDataTopic extends AppDataTopic {
    public enum RadarSourceDataTypes {
        ...
        PHONE_CALL, PHONE_SMS, PHONE_BLUETOOTH_DEVICES, PHONE_SMS_UNREAD, PHONE_CONTACTS, PHOTOPLETHYSMOGRAPHY,
        RELATIVE_LOCATION, RESPIRATION_RATE, STEP_COUNT, THERMOMETER, USAGE_EVENT, USER_INTERACTION
    }
